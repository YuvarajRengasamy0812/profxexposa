                                ...
                                <div className="product-left text-center">
                                    <div className="row gy-4">
                                        <div className="col-lg-6 col-md-6">
                                            <div className="product-box p-3 pb-4 box-shadow rounded me-1 m-md-0">
                                                <div className="product-img mb-5">
                                                    <Link to="/Productdetail"><img src={`${process.env.PUBLIC_URL}/assets/images/product/1.jpg`} alt="Bamboo Bucket" className="w-100 rounded"/></Link>
                                                </div>
                                        ...
                                        <div className="col-lg-6 col-md-6">
                                            <div className="product-box p-3 pb-4 box-shadow rounded ms-1 m-md-0">
                                                <div className="product-img mb-5 position-relative">
                                                    ...
                                                    <Link to="/Productdetail"><img src={`${process.env.PUBLIC_URL}/assets/images/product/2.jpg`} alt="Bamboo Bucket" className="w-100 rounded"/></Link>
                                                </div>
                                                <div className="product-info mb-3">
                                        ...
                                        <div className="col-lg-6 col-md-6">
                                            <div className="product-box p-3 pb-4 box-shadow rounded me-1 m-md-0">
                                                <div className="product-img mb-5 position-relative">
                                                    ...
                                                    <Link to="/Productdetail"><img src={`${process.env.PUBLIC_URL}/assets/images/product/3.jpg`} alt="Bamboo Bucket" className="w-100 rounded"/></Link>
                                                </div>
                                                <div className="product-info mb-3">
                                        ...
                                        <div className="col-lg-6 col-md-6">
                                            <div className="product-box p-3 pb-4 box-shadow rounded ms-1 m-md-0">
                                                <div className="product-img mb-5">
                                                    <Link to="/Productdetail"><img src={`${process.env.PUBLIC_URL}/assets/images/product/4.jpg`} alt="Bamboo Bucket" className="w-100 rounded"/></Link>
                                                </div>
                                                <div className="product-info mb-3">
                                        ...
                                        <div className="col-lg-6 col-md-6">
                                            <div className="product-box p-3 pb-4 box-shadow rounded me-1 m-md-0">
                                                <div className="product-img mb-5">
                                                    <Link to="/Productdetail"><img src={`${process.env.PUBLIC_URL}/assets/images/product/5.jpg`} alt="Bamboo Bucket" className="w-100 rounded"/></Link>
                                                </div>
                                                <div className="product-info mb-3">
                                        ...
                                        <div className="col-lg-6 col-md-6">
                                            <div className="product-box p-3 pb-4 box-shadow rounded ms-1 m-md-0">
                                                <div className="product-img mb-5">
                                                    <Link to="/Productdetail"><img src={`${process.env.PUBLIC_URL}/assets/images/product/6.jpg`} alt="Bamboo Bucket" className="w-100 rounded"/></Link>
                                                </div>
                                                <div className="product-info mb-3">
                            ...
                            <div className="product-gallery p-6 box-shadow rounded mb-6">
                                ...
                                <div className="product-gallery-inner ">
                                    <div id="selector1" className="row g-3 ">
                                        <div className="item col-lg-6 col-md-6 position-relative" data-src={`${process.env.PUBLIC_URL}/assets/images/product/6.jpg`}>
                                            <a >
                                                <div className="image-overlay rounded mx-1"></div>
                                                <img src={`${process.env.PUBLIC_URL}/assets/images/product/6.jpg`} className="w-100 rounded position-relative" alt="Yellow Sofa"/>
                                            </a>
                                        </div>
                                        <div className="item  col-lg-6 col-md-6 position-relative" data-src={`${process.env.PUBLIC_URL}/assets/images/product/4.jpg`}>
                                            <a>
                                                <div className="image-overlay rounded mx-1 "></div>
                                                <img src={`${process.env.PUBLIC_URL}/assets/images/product/4.jpg`} className="w-100 rounded position-relative" alt="Lewis Shirt"/>
                                            </a>
                                        </div>
                                        <div className="item col-lg-6 col-md-6 position-relative" data-src={`${process.env.PUBLIC_URL}/assets/images/product/5.jpg`}>
                                            <a>
                                                <div className="image-overlay rounded mx-1"></div>
                                                <img src={`${process.env.PUBLIC_URL}/assets/images/product/5.jpg`} className="w-100 rounded position-relative" alt="London T-Shirt"/>
                                            </a>
                                        </div>
                                        <div className="item  col-lg-6 col-md-6 position-relative" data-src={`${process.env.PUBLIC_URL}/assets/images/product/3.jpg`}>
                                            <a>
                                                <div className="image-overlay rounded mx-1"></div>
                                                <img src={`${process.env.PUBLIC_URL}/assets/images/product/3.jpg`} className="w-100 rounded position-relative" alt="Leather Bag"/>
                                            </a>
                                        </div>
                                        <div className="item  col-lg-6 col-md-6 position-relative" data-src={`${process.env.PUBLIC_URL}/assets/images/product/2.jpg`}>
                                            <a>
                                                <div className="image-overlay rounded mx-1"></div>
                                                <img src={`${process.env.PUBLIC_URL}/assets/images/product/2.jpg`} className="w-100 rounded position-relative" alt="Ladies Top"/>
                                            </a>
                                        </div>
                                        <div className="item  col-lg-6 col-md-6 position-relative" data-src={`${process.env.PUBLIC_URL}/assets/images/product/1.jpg`}>
                                            <a>
                                                <div className="image-overlay rounded mx-1"></div>
                                                <img src={`${process.env.PUBLIC_URL}/assets/images/product/1.jpg`} className="w-100 rounded position-relative" alt="Bamboo Bucket"/>
                                            </a>
                                        </div>
                                    </div> 
                                </div>  
                                ...
                                <div className="recent-product-list">
                                    ...
                                    <div className="col-lg-12 col-md-6">
                                        <div className="recent-product d-flex align-items-center  mb-3">
                                            ...
                                            <Link to="/Productdetail"><img src={`${process.env.PUBLIC_URL}/assets/images/product/6.jpg`} alt="Yellow Sofa" className="rounded me-3"/></Link>
                                            </div>
                                    ...
                                    <div className="col-lg-12 col-md-6">
                                        <div className="recent-product d-flex align-items-center mb-3">
                                            <div className="product-img">
                                            <Link to="/Productdetail"><img src={`${process.env.PUBLIC_URL}/assets/images/product/3.jpg`} alt="Leather Bag" className="rounded me-3"/></Link>
                                            </div>
                                            <div className="product-detail">
                                    ...
                                    <div className="col-lg-12 col-md-6">
                                        <div className="recent-product d-flex align-items-center mb-4">
                                            <div className="product-img">
                                            <Link to="/Productdetail"><img src={`${process.env.PUBLIC_URL}/assets/images/product/1.jpg`} alt="Bamboo Bucket" className="rounded me-3"/></Link>
                                            </div>
                                            <div className="product-detail">
                                    ...
                                    <div className="col-lg-12 col-md-6">  
                                        <div className="recent-product d-flex align-items-center mb-4">
                                            <div className="product-img">
                                            <Link to="/Productdetail"><img src={`${process.env.PUBLIC_URL}/assets/images/product/4.jpg`} alt="Lewis Shirt" className="rounded me-3"/></Link>
                                            </div>
                                            <div className="product-detail">
