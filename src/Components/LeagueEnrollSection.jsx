...
const LeagueEnrollSection = ({ showBackLink = true }) => {
                    ...
                    <div className="form-check">
                      ...
                      <label className="form-check-label" htmlFor="leagueTerms">
                        ...
                        <button
                          ...
                          style={{ color: "#c19d38", fontWeight: 600, cursor: "pointer", background: "none", border: 0, padding: 0 }}
...
export default LeagueEnrollSection;
